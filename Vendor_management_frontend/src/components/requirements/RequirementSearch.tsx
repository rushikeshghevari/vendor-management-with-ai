...
/** Rounded pill search input used at the top of the Requirements list. */
export const RequirementSearch = forwardRef<RNTextInput, RequirementSearchProps>(function RequirementSearch(
  { value, onChangeText, placeholder = 'Search by requirement number or title...' },
  ref,
) {
  return (
